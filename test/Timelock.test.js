...
contract('Timelock', ([alice, bob, carol, dev, minter]) => {
    beforeEach(async () => {
        this.cake = await CumToken.new({ from: alice });
    ...
    it('should also work with MasterUniHub', async () => {
        ...
        this.chef = await MasterUniHub.new(this.cake.address, this.syrup.address, dev, '1000', '0', { from: alice });
