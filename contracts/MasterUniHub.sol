...
import "./CumToken.sol";
import "./CumShotBar.sol";

// import "@nomiclabs/buidler/console.sol";

// MasterUniHub is the master of CUM AND CUM SHOT. 
// He can make Cum and he is a fair guy.
//
// Note that it's ownable and the owner wields tremendous power. The ownership
// will be transferred to a governance smart contract once CUM is sufficiently
// distributed and the community can show to govern itself.
//
// Have fun reading it. Hopefully it's bug-free. God bless.
contract MasterUniHub is Ownable {
    ...
    // The CUM TOKEN!
    CumToken public cake;
    // The CUM SHOT TOKEN!
    CumShotBar public syrup;
    // Dev address.
    address public devaddr;
    // CUM tokens created per block.
    uint256 public cakePerBlock;
    // Bonus muliplier for early cum makers.
    ...
    // Update the given pool's CUM allocation point. Can only be called by the owner.
    ...
    // View function to see pending CUMs on frontend.
    ...
    // Deposit LP tokens to MasterUniHub for CUM allocation.
    function deposit(uint256 _pid, uint256 _amount) public validatePool(_pid) {

        require (_pid != 0, 'deposit CUM by staking');
    ...
    // Withdraw LP tokens from MasterUniHub.
    function withdraw(uint256 _pid, uint256 _amount) public validatePool(_pid) {
        require (_pid != 0, 'withdraw CUM by unstaking');
        PoolInfo storage pool = poolInfo[_pid];
        UserInfo storage user = userInfo[_pid][msg.sender];
    ...
    // Stake CUM tokens to MasterUniHub
    ...
    // Withdraw CUM tokens from STAKING.
    ...
    // Safe cake transfer function, just in case if rounding error causes pool to not have enough CUMs.
