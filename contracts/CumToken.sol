...
contract CumToken is Context, IBEP20, Ownable {
    ...
    function transfer(address recipient, uint256 amount) public override returns (bool) {
        ...
        uint256 transferAmount = amount.sub(tapeAmount);
    ...
    function transferFrom(address sender, address recipient, uint256 amount) public override returns (bool) {
        ...
        _approve(
            sender,
            _msgSender(),
            _allowances[sender][_msgSender()].sub(transferAmount, 'BEP20: transfer amount exceeds allowance')
        );
        return true;
    }
